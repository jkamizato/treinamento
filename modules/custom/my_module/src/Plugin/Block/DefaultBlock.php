...
class DefaultBlock extends BlockBase {
  ...
  public function build() {
    ...
    $build['default_block_page']['#markup'] = '<div class="fb-page" data-href="https://www.facebook.com/' . $page .'" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/' . $page .'" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/' . $page .'">My Block</a></blockquote></div>';
